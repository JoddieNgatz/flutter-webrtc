...
import '../utils/turn_web.dart';

import '../utils/device_info_web.dart';
...
class Signaling {
  ...
  String _selfId = 'pass host id';
  String bookingId = 'pass chanel id';
  ...
  Future<void> connect() async {
    ...
    _localStream = await createStream('false', false);
    try {
  ...
  Future<MediaStream> createStream(String media, bool userScreen,
    ...
    //   };
    // }
    debugPrint(mediaConstraints.toString());
    MediaStream stream;
    if (userScreen) {
  ...
  // Future<MediaStream> createStream(String s,
  //     {bool audioOnly, BuildContext context}) async {
  //   Map<String, dynamic> mediaConstraints = {};
  //   if (WebRTC.platformIsAndroid) {
  //     mediaConstraints = {
  //       'audio': true,
